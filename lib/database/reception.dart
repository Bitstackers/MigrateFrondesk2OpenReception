...
//Future<List<adaheads_model.Reception>> _getOrganizationReceptionList(Pool pool, int organizationId) {
//  String sql = '''
...
//    List<adaheads_model.Reception> receptions = new List<adaheads_model.Reception>();
//    for(var row in rows) {
//      receptions.add(new adaheads_model.Reception.fromDB(
//          row.id,
//          row.organization_id,
//          row.full_name,
...
//Future<adaheads_model.Reception> _getReception(Pool pool, int organizationId, int receptionId) {
//  String sql = '''
//    SELECT id, organization_id, full_name, attributes, extradatauri, enabled, reception_telephonenumber
//    FROM receptions
//    WHERE id = @id AND organization_id=@organization_id
...
//    } else {
//      Row row = rows.first;
//      return new adaheads_model.Reception.fromDB(
//          row.id,
//          row.organization_id,
//          row.full_name,
//          JSON.decode(row.attributes != null ? row.attributes : '{}'),
...
//Future<List<adaheads_model.Reception>> _getReceptionList(Pool pool) {
//  String sql = '''
//    SELECT id, organization_id, full_name, attributes, extradatauri, enabled, reception_telephonenumber
//    FROM receptions
//  ''';
...
//Future<List<adaheads_model.Reception>> _getContactReceptions(Pool pool, int contactId) {
//  String sql = '''
